...
export default function Footer() {
  ...
  return (
    <footer className="text-gray-300" style={footerStyle}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-start">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              Vritti is on a mission to transform careers and companies in the
              oil & gas sector—by putting real skills and readiness at the heart
          ...
          <div className="space-y-8 sm:space-y-10">
            <div>
              <h4 className="font-bold mb-4 text-yellow-400 tracking-wider text-sm sm:text-base">
                QUICK LINKS
              </h4>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <button className="bg-orange-500 hover:bg-orange-600 text-black px-4 sm:px-6 py-2 sm:py-3 rounded-full font-semibold text-xs sm:text-sm w-full sm:w-auto flex justify-between items-center group transition-colors">
      ...
      <div className="bg-orange-500 text-center py-3 sm:py-4 px-4 sm:px-6">
